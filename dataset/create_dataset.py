...
from dataset.transcribe import Whisper
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--model", help="The model to use", type=str, default="large-v3")
    ...
    create_dataset(
        ...
        transcription_model=Whisper(args.model),
